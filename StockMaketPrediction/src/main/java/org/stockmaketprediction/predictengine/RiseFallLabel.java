...
public class RiseFallLabel {
	...
	/**
	 * 
	 * Returns a list of the data set label, assume that the problem is there is
	 * no chance three days before to 30 days after the information to predict
	 * price ( average closing price for the first three days is greater than 30
	 * days )
	 * 
	 * @param price_list
	 *            Four daily price
