package org.stockmaketprediction.spark;
...
public class DecisionTreeRegressor implements Serializable {
	...
	public String modelGenerator(String cpName, String datapath) throws IOException {
		...
		// String datapath =
		// "H:\\CMPE239\\formattedDataSet\\EOD-GOOGL-labled.csv";
		...
		JavaRDD<LabeledPoint> parsedData = data.map(new Function<String, LabeledPoint>() {
			public LabeledPoint call(String line) {
				...
				return new LabeledPoint(Double.valueOf(features[0]), Vectors.dense(v));
			}
		});
		...
		// double[] result =
		// {20160429,704.12,712.11,703.78,707.88,0,1,704.12,712.11,703.78,707.88,2913898};
