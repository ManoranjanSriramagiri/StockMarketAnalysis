...
public class DecisionTreeRegressorController {
	...
	// String[] datapath = { "data//EOD-CSCO-labled.csv",
	// "data//EOD-FB-labled.csv", "data//EOD-GOOGL-labled.csv",
	// "data//EOD-IBM-labled.csv", "data//EOD-INTU-labled.csv",
	// "data//EOD-MSFT-labled.csv", };
	// String[] compName = { "CISCO", "FACEBOOK", "GOOGLE", "IBM", "INTUIT",
	// "MICROSOFT" };

	// public static void main(String[] args) throws IOException {
	//
	// DecisionTreeRegressorController xy = new
	// DecisionTreeRegressorController();
